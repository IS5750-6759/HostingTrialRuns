...
export const loader = async ({ params }) => {
  const { id } = params;
  const { data } = await axios.get(`https://script.google.com/macros/s/AKfycbynsFiK9xHDXtLY_X9ohpW48-KyMpr1Mhm8JBlN0DT6UPQbEhXbauJ9R1xb4teTiMMYhA/exec/videos/${id}`);
...
export const action = async ({ params, request }) => {
  ...
  if (isValidUrl(youtubeUrl)) {
    try {
      await axios.put("https://script.google.com/macros/s/AKfycbynsFiK9xHDXtLY_X9ohpW48-KyMpr1Mhm8JBlN0DT6UPQbEhXbauJ9R1xb4teTiMMYhA/exec/videos/" + id, { id, title, youtubeUrl, playlistId })
